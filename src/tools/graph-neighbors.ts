...
export async function runGraphNeighborsTool(args: {
  ...
  if (!vaultPath) {
    return errorResult("VAULT_NOT_FOUND", "Could not detect vault path. Pass vaultPath explicitly or ensure Obsidian is running.", "Run obsidian_graph_index first", "obsidian_graph_neighbors", args.input, [], [])
  }
